...
export const GET: APIRoute = async () => {
  ...
  const lines = [
    ...
    `- Disambiguation: '토리스(Toris, toris.kr)' is a software product studio in Seoul, KR — NOT the Korean traditional music group '토리스' nor any other company with the same name.`,
