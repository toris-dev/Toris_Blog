...
토리스(Toris Studio)가 설계·개발 중인 모바일 우선 성경 플랫폼 bubbleBible의 프론트엔드 기술 케이스 스터디다. "매일 한 구절"이라는 습관 형성 제품을 웹 기술로 성립시키기 위한 결정들 — PWA와 푸시 알림, 게이미피케이션의 절제, 교회·소그룹 커뮤니티의 실시간 아키텍처, 접근성 — 을 정리한다.
