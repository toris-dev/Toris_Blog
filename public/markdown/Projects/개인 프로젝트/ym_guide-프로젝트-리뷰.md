...
토리스(Toris Studio)가 설계·개발·운영하는 청년 혜택 큐레이션 플랫폼 ym_guide의 기술 케이스 스터디다. 공공 데이터를 원료로 삼되 공공 포털이 풀지 못한 "탐색 비용" 문제를 제품으로 푸는 과정 — 데이터 가공 계층 설계, 질문 기반 추천 시스템, Supabase 백엔드 구성 — 을 정리한다.
