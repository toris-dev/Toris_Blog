...
- **역할**: FullStack Developer (약 3개월차, 2026.02 ~ )
- **기술 스택**: React Native(Expo), NestJS·tRPC, Next.js, PostgreSQL, AWS(ECS Fargate, RDS, S3, ALB), Terraform, Docker
- **설명**: 병원·모델·사용자 B2B2C. 전자계약·포인트·쿠폰·알림 올인원. KB국민은행 API 연동(계좌·송금), Modusign 등 전자서명·PDF 파이프라인
- **블로그 글**: [21n-econtract-platform](/posts/21n-econtract-platform)
