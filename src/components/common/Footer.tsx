...
export default function Footer() {
  ...
  return (
    <footer
      ...
      className="w-full border-t border-[var(--toris-border)] bg-[var(--toris-canvas)] text-[var(--toris-ink)]"
    >
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-[1.25fr_0.75fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-sm text-pretty break-keep text-sm leading-7 text-[var(--toris-ink-muted)]">
          ...
          <nav aria-label="푸터 메뉴">
            <h2 className="text-sm font-bold text-[var(--toris-ink)]">탐색</h2>
          ...
          <div>
            <h2 className="text-sm font-bold text-[var(--toris-ink)]">
              사업자 정보
            </h2>
            <dl className="mt-5 space-y-3 text-sm">
              <div className="grid grid-cols-[5rem_1fr] gap-3">
                <dt className="text-[var(--toris-ink-muted)]">상호</dt>
                <dd className="font-semibold text-[var(--toris-ink)]">
                  {studioBusiness.name}
                </dd>
              </div>
              <div className="grid grid-cols-[5rem_1fr] gap-3">
                <dt className="text-[var(--toris-ink-muted)]">대표</dt>
                <dd className="font-semibold text-[var(--toris-ink)]">
              ...
              {studioBusiness.registrationNumber ? (
                <div className="grid grid-cols-[5rem_1fr] gap-3">
                  <dt className="text-[var(--toris-ink-muted)]">사업자번호</dt>
                  <dd className="font-semibold text-[var(--toris-ink)]">
                    {studioBusiness.registrationNumber}
                  </dd>
                </div>
              ...
              <div className="grid grid-cols-[5rem_1fr] gap-3">
                <dt className="text-[var(--toris-ink-muted)]">이메일</dt>
                <dd>
                  <a
                    href={`mailto:${studioBusiness.email}`}
              ...
              <div className="grid grid-cols-[5rem_1fr] gap-3">
                <dt className="text-[var(--toris-ink-muted)]">협업</dt>
                <dd className="font-semibold text-[var(--toris-ink)]">
        ...
        <div className="mt-12 flex flex-col gap-2 border-t border-[var(--toris-border)] pt-6 text-xs text-[var(--toris-ink-muted)] sm:flex-row sm:items-center sm:justify-between">
