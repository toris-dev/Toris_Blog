...
export function SceneHeading({
  ...
  return (
    <div className={cn('max-w-2xl', className)}>
      <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs font-medium uppercase tracking-widest text-indigo-300">
...
export function Chip({
  ...
  return (
    <span
      className={cn(
        'inline-flex items-center rounded-md border border-white/10 bg-white/5 px-2.5 py-1 text-xs font-medium text-slate-200',
        className
      )}
    >
      {children}
