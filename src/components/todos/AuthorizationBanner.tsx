  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        exit={{ opacity: 0, y: -20 }}
        className="mb-6 rounded-lg border border-yellow-500/50 bg-yellow-500/10 p-4"
      >
        <div className="flex items-start gap-3">
          <FaInfoCircle className="mt-0.5 size-5 shrink-0 text-yellow-600 dark:text-yellow-400" />
